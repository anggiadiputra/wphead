...
export default function FloatingSocialShare({ post, url }: FloatingSocialShareProps) {
  ...
  return (
    <div className="fixed left-4 top-1/2 transform -translate-y-1/2 z-50 hidden xl:block">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-3 backdrop-blur-sm bg-opacity-95">
        {/* Header */}
        ...
        <div className="flex flex-col gap-2">
          {platforms.map((platform) => (
            <button
              ...
              className={`
                ...
                dark:bg-gray-700 dark:hover:bg-current
                group
              `}
          ...
          <button
            ...
            className={`
              ...
              ${copied 
                ? 'text-blue-600 border-blue-300 bg-blue-50 dark:bg-blue-900' 
                : 'text-blue-600 border-gray-200 dark:border-gray-600 dark:bg-gray-700'
              }
        ...
        {/* Share Count (Optional - would need backend integration) */}
        <div className="text-center mt-3 pt-3 border-t border-gray-200 dark:border-gray-600">
